<script>
    ...
    function handleToggleComplete(event) {
        ...
        const updatedTodo = {...todo[todoIndex], completed: !todos[todoIndex].completed}
...
<div class="container">
    <img class="logo" src="https://pbs.twimg.com/profile_images/1121395911849062400/7exmJEg4.png" alt="CodingTheSmartWay Logo">
